...
set ::env(CLOCK_NET) "OQPSK_RCOSINE_ALL.ACK"
...
set ::env(FP_PDN_MACRO_HOOKS) "\
	OQPSK_RCOSINE_ALL vdd vss vdd vss"
...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$::env(CARAVEL_ROOT)/verilog/rtl/defines.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/OQPSK_RCOSINE_ALL.v"

set ::env(EXTRA_LEFS) "\
	$::env(DESIGN_DIR)/../../lef/OQPSK_RCOSINE_ALL.lef"

set ::env(EXTRA_GDS_FILES) "\
	$::env(DESIGN_DIR)/../../gds/OQPSK_RCOSINE_ALL.gds"
